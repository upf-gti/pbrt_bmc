...
//  public:
//    // BayisianMonteCarloIntegrator Public Methods
//    AreaIntegrator(Camera camera, Sampler sampler, Primitive aggregate,
//                   std::vector<Light> lights);
//
//    SampledSpectrum Li(RayDifferential ray, SampledWavelengths &lambda, Sampler sampler,
//                       ScratchBuffer &scratchBuffer,
...
//                       VisibleSurface *visibleSurface) const;
//
//    Vector3f random_on_area(Point3f corner, Vector3f diagonal);
//    Vector3f sampling(Vector3f (*func)(Point3f), Point3f c);
//
